...
1. **set up your fork** — see ["Building"](https://github.com/pdfclown/jada-examples/blob/main/docs/building.md#setup) for step-by-step instructions
