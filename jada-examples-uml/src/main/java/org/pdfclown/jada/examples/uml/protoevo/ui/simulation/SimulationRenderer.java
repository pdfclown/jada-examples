...
import java.awt.*;
import java.util.*;
import org.pdfclown.jada.examples.uml.protoevo.biology.*;
import org.pdfclown.jada.examples.uml.protoevo.core.*;
import org.pdfclown.jada.examples.uml.protoevo.env.ChemicalSolution;
...
import org.pdfclown.jada.examples.uml.protoevo.utils.Utils;
  ...
  public void drawOutlinedCircle(Graphics2D g, Vector2 pos, float r, Color c, float edgeAlpha) {
    ...
    if (edgeAlpha < 1)
      edgeColour = new Color(
          edgeColour.getRed(), edgeColour.getGreen(), edgeColour.getBlue(),
          (int) (255 * edgeAlpha));
  ...
  public void renderEntityAttachments(Graphics2D g, Cell e) {
    ...
    for (CellAdhesion.CellBinding binding : e.getCellBindings()) {
      ...
      g.setColor(new Color(
          ...
          (blue + attachedColor.getBlue()) / 2).brighter());
