...
public abstract class ConstructionProject implements Serializable {
  ...
  /**
   * @param requiredMass
   *          required mass to contribute to project
   * @param requiredEnergy
   *          required energy to contribute to project
   * @param timeToComplete
   *          required time to contribute to project
   * @param requiredComplexMolecules
   *          required complex molecules to contribute to project
   */
