...
import org.pdfclown.jada.examples.uml.protoevo.core.Collidable;
...
public class Rock extends Collidable implements Serializable {
  ...
  public static float[] edgesIntersectCoef(Vector2 start1, Vector2 dir1, Vector2 start2,
      Vector2 dir2, float[] ts) {
