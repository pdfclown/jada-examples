...
public final class Settings {
  ...
  // Simulation settings
  public static final long simulationSeed =
      getInstance().simulation_seed == 0 ? System.currentTimeMillis()
          : getInstance().simulation_seed;
  ...
  public static final float chemicalsUpdateTime =
      simulationUpdateDelta * getInstance().chemical_update_interval;
  ...
  public static final float spikePlantConsumptionPenalty =
      getInstance().spike_plant_consumption_penalty;
